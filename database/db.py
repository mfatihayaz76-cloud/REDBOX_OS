...
def init_database():
    ...
    try:
        ...
        # Firma ve ürüne özel iş verileri burada otomatik
        # oluşturulmaz. Fresh-install kimliği COM-1 ilk kurulum
        # motoru tarafından açık kullanıcı onayıyla oluşturulur.
        ...
        # GERCEK ve DEMO başlangıç verileri init_database
        # içinde yüklenmez. Kullanım modu ilk kurulum motorunun
        # kontrollü ve atomik akışıyla yönetilir.
